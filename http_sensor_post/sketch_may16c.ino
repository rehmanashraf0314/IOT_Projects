...
String serverName = "http://192.132.45.134:1880/update-sensor";
// http://192.168.43.255:1880/#/flow/def64e5b938b64e2
...
void loop() {
 ...
 // If you need Node-RED/server authentication, insert
